// Adapted from DeepSeek Harness (MIT, Copyright 2026 DeepSeek). See apps/web/LICENSE-deepseek-harness.
/** Operation-sequence and recorded-time projections for the trajectory overview. */

import type { TrajectoryTurnModel } from "./trajectoryTimelineAdapter";
import type { TrajectoryTranslate } from "./trajectoryLocale";
import type { TrajectoryCellKind, TrajectoryCellProps } from "./trajectoryTimelineAdapter";
 ...
 */
export function formatTimelineOffset(milliseconds: number, _t: TrajectoryTranslate): string {
