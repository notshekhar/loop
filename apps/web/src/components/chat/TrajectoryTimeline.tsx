...
import { TrajectoryTooltip as Tooltip } from "./TrajectoryTooltip";
...
import type {
  ...
  TrajectoryCellKind,
  TrajectoryCellProps,
} from "./trajectoryTimelineAdapter";
import {
...
function timelineKindLabel(kind: TrajectoryCellKind, t: TrajectoryTranslate): string {
  switch (kind) {
    ...
    case "user":
      return t("kind.user");
    case "context":
      return t("kind.context");
    case "compacted":
      return t("kind.compacted");
    case "message":
      return t("kind.assistant");
    case "tool":
      return t("kind.tool");
    case "subtool":
      return t("kind.subtool");
  }
}
