...
const PIERRE_ICON_SPRITE_ID = "loop-pierre-file-icon-sprite";

const LOOP_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="loop-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="loop-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="loop-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="loop-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="loop-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="loop-file-icon-pnpm" viewBox="0 0 32 32">
...
export const LOOP_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: LOOP_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "loop-file-icon-package-json",
    "tsconfig.json": "loop-file-icon-tsconfig",
    "agents.md": "loop-file-icon-agents",
    "claude.md": "loop-file-icon-claude",
    "readme.md": "loop-file-icon-readme",
    "pnpm-lock.yaml": "loop-file-icon-pnpm",
    "pnpm-workspace.yaml": "loop-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(LOOP_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${LOOP_FILE_ICON_SPRITE}`;
