...
const PUBLISH_RESULT: SourceControlPublishRepositoryResult = {
  repository: {
    provider: "github",
    nameWithOwner: "notshekhar/loop",
    url: "https://github.com/notshekhar/loop",
    sshUrl: "git@github.com:notshekhar/loop.git",
  },
  remoteName: "origin",
  remoteUrl: "git@github.com:notshekhar/loop.git",
  branch: "main",
