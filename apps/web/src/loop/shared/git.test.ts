...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:Notshekhar/Loop.git")).toBe(
      "github.com/notshekhar/loop",
    );
    expect(normalizeGitRemoteUrl("https://github.com/Notshekhar/Loop.git")).toBe(
      "github.com/notshekhar/loop",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/Notshekhar/Loop")).toBe(
      "github.com/notshekhar/loop",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:Notshekhar/platform/Loop.git")).toBe(
      "gitlab.com/notshekhar/platform/loop",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/Notshekhar/platform/Loop.git")).toBe(
      "gitlab.com/notshekhar/platform/loop",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:Notshekhar/Loop.git"),
    ).toBe("Notshekhar/Loop");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/Notshekhar/Loop.git"),
    ).toBe("Notshekhar/Loop");
  });
});
